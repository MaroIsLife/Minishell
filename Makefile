...
SRC = commands.c find_argument.c find_command.c find_utils.c main.c misc.c parse.c read.c sigs.c commands_list.c commands_utils.c environement.c ft_split.c
CC = gcc 
