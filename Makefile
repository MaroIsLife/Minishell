...
SRC = commands.c find_argument.c find_command.c find_utils.c find_utils_two.c find_utils_three.c main.c main_two.c main_three.c misc.c parse.c parse_two.c parse_three.c sigs.c commands_list.c commands_utils.c environement.c ft_split.c helpers.c test2.c test3.c fork_pipes.c count_starts.c find_red.c count_argument.c find_arguments_utils.c red_open.c execute.c execute_utils.c exit.c unset.c export_one.c export_two.c export_three.c sort.c cdpwd.c export_four.c find_command_two.c
CC = gcc
